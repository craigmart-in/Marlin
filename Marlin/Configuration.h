 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 99.45 } // CM
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 100, 10000 } // CM
 ...
 */
#define Z_MIN_PROBE_PIN PC14 // CM
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -4.2, -0.78 } // CM
...
#define PROBING_MARGIN 0 // CM

// X and Y axis travel speed (mm/min) between probes
#define XY_PROBE_FEEDRATE (133*60)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (6*60) // CM
...
#define X_BED_SIZE 228 // CM - Nozzle at 0 is over the bed so reduce from bed size instead.
#define Y_BED_SIZE 235

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS 0 // CM
#define Y_MIN_POS -5 // CM
#define Z_MIN_POS 0
#define X_MAX_POS (X_BED_SIZE + 17) // CM - A little more room in the x gantry for probing.
#define Y_MAX_POS (Y_BED_SIZE + 5) // CM
...
#define AUTO_BED_LEVELING_UBL // CM
//#define MESH_BED_LEVELING // CM
...
//#define DEBUG_LEVELING_FEATURE
   ...
   */
  #define G26_MESH_VALIDATION // CM
  #if ENABLED(G26_MESH_VALIDATION)
    #define MESH_TEST_NOZZLE_SIZE    0.4  // (mm) Diameter of primary nozzle.
    #define MESH_TEST_LAYER_HEIGHT   0.24  // (mm) Default layer height for G26. // CM
  ...
  #define MESH_INSET 5              // Set Mesh bounds as an inset region of the bed // CM
  #define GRID_MAX_POINTS_X 10      // Don't use more than 15 points per axis, implementation limited.
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X

  #define UBL_HILBERT_CURVE       // Use Hilbert distribution for less travel when probing multiple points // CM
