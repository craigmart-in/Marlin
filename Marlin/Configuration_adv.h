...
#define INPUT_SHAPING_Y // CM
    ...
    #define SHAPING_FREQ_X  35.91          // (Hz) The default dominant resonant frequency on the X axis. // CM
    #define SHAPING_ZETA_X  0.15f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  35.91          // (Hz) The default dominant resonant frequency on the Y axis. // CM
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu // CM
     ...
     */
    #define PROBE_OFFSET_WIZARD_START_Z -4.0 // CM
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.15 }     // (mm) Compression length per 1mm/s extruder speed, per extruder // CM
  #else
    #define ADVANCE_K 0.15         // (mm) Compression length applying to all extruders // CM
  #endif
 ...
 */
  ...
  #define PROBING_MARGIN_LEFT PROBING_MARGIN // CM
  #define PROBING_MARGIN_RIGHT PROBING_MARGIN // CM
  ...
  #define MESH_MIN_X 0 // CM
  #define MESH_MIN_Y MESH_INSET // CM
  #define MESH_MAX_X X_BED_SIZE + (17) // CM
  #define MESH_MAX_Y Y_BED_SIZE - (MESH_INSET) // CM
#endif
